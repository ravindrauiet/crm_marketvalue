...
export default function POPage() {
  ...
  return (
    <div className="container fade-in">
      ...
      {/* Main Tab Navigation: PO Records List vs Chain / Buyer PO Uploads */}
        ...
        <div>
          ...
          {loading ? (
            ...
            <div className="card" style={{ padding: 64, textAlign: 'center' }}>
              ...
              <h3>No POs found</h3>
              <p className="muted" style={{ marginBottom: 24 }}>Create your first PO from a chain or upload a PO document.</p>
              <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
                <Link href="/po/new" className="btn">+ Add PO Manually</Link>
