  ...
  return (
    <div className="container fade-in">
      <div className="row" style={{ justifyContent: 'space-between', marginBottom: 24, alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
        <h2 style={{ margin: 0 }}>Customers & Vendors</h2>
        <div className="row" style={{ gap: 12 }}>
          <input
            ...
            style={{ width: 250 }}
          />
          <a href="/api/export/customers" className="btn secondary" download>Export</a>
          <Link className="btn" href="/customers/new">Add Contact</Link>
        </div>
      </div>
      ...
      <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
        {loading ? (
          ...
          <div style={{ padding: 48, textAlign: 'center' }}>
            <div className="muted">No contacts found. <Link href="/customers/new" style={{ color: 'var(--primary)' }}>Add your first contact</Link></div>
          </div>
        ) : (
